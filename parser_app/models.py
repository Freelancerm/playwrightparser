...
class Product(models.Model):
    ...
    price = models.DecimalField(decimal_places=2, max_digits=10, null=True, blank=True, default=None)
    ...
    screen_resolution = models.CharField(max_length=50, null=True, blank=True, default=None)
    characteristics = models.JSONField(null=True, blank=True, default=None)  # Dictionary of characteristics
